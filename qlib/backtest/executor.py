...
class BaseExecutor:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # record dealt order amount across the whole backtest
        # this is used for volume related constraints
...
class SimulatorExecutor(BaseExecutor):
    ...
    def _collect_data(
        ...
        for order in self._get_order_iterator(trade_decision):
            # execute the order without assuming daily trading sessions
            # the `dealt_order_amount` will keep accumulating during the whole backtest
